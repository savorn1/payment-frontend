...
// Payment-wallet's admin endpoints don't all expose a generic update (e.g. users
// only have specialized /role, /status, /password endpoints), so `update` is
// optional — pages that don't pass it simply never call openEdit/onEdit.
